    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "A delicious taco", "Beef Taco", 2.50m, 100 },
                    { 2, 1, "A tasty chicken burrito", "Chicken Burrito", 3.75m, 80 },
                    { 3, 2, "A healthy vegetable wrap", "Veggie Wrap", 2.25m, 50 },
                    { 4, 2, "Cheesy and warm quesadilla", "Cheese Quesadilla", 2.00m, 70 },
                    { 5, 3, "Fresh fish with spicy sauce", "Fish Tacos", 3.00m, 60 }
                });
